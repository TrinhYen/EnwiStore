        ...
        <?php foreach ($result as $key => $value): ?>
            <div class="brand_item-box">
                <div class="brand_img-box  item-1" style="background-image: url(<?php echo base_url('uploads/'.$value['TenAnh']); ?>)">
                    <a href="<?php echo base_url('san-pham/'.$value['MaSP']); ?>"> Xem Thêm </a>
                </div>
        ...
        <div class="row ">
            ...
            <div class="col-md-6 ">
                ...
                <div class="detail_box ">
                    ...
                    <p>
                        Enwi đã nhận biết được vấn đề này của mọi người, vậy nên hôm nay Enwi sẽ hướng dẫn bạn cách lau chùi, vệ sinh chiếc kính của bạn thật sạch sẽ mỗi ngày, để có một tầm mình thật sáng rõ và tươi mới.
                    </p>
                </div>
            </div>
            <div class="col-md-6 ">
