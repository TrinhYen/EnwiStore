		...
		<div id="TaiKhoan" class="tabcontent">
	      ...
	      <?php } ?>
				<form method="POST" style="padding: 15px;">
					...
					<input type="tel" id="lname" name="sodienthoai" min=10 size=10 placeholder="Số điện thoại..." value="<?php echo $customer[0]['SDT'] ?>" required>

					<label for="lname">Email</label>
					<input type="email" id="lname" name="email" placeholder="Email khách hàng..." value="<?php echo $customer[0]['Email'] ?>" required>
