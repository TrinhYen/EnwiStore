    ...
    <div class="container">
        <div class="row">
            <div class="cartegory-left">
                <ul>
                    <li class="cartegory-left-li"><a href="<?php echo base_url('chuyen-muc/L001/') ?>">Gọng kính</a>
                    </li>
                    <li class="cartegory-left-li"><a href="<?php echo base_url('chuyen-muc/L002/') ?>">Kính râm</a></li>
                    <li class="cartegory-left-li"><a href="<?php echo base_url('chuyen-muc/L003/') ?>">Tròng kính</a>
                    </li>
            ...
            <div class="cartegory-right-top-item">
                <div class="cartegory-right">
                    <p style="font-weight: bold">Kết quả tìm kiếm sản phẩm:
                        <?php echo $_GET['s']; ?>
                    </p>
                </div>
                        ...
                        <?php foreach ($result as $key => $value): ?>
                            <div class="cartegory-right-content-item">
                                ...
                                <h1><a style="color: black;"
                                        href="<?php echo base_url('san-pham/' . $value['MaSP']); ?>"><?php echo $value['TenSP']; ?></a></h1>
                                <p>
                                    <?php echo number_format($value['GiaTien']); ?><sup>đ</sup>
                                </p>
                                <!-- <div class="colors">
                ...
                <div class="pagination" style="margin-top: 30px; margin-bottom: 30px;">
                        ...
                        <?php } else if (isset($_GET['trang'])) { ?>
                                <a
                                    href="<?php echo base_url('tim-kiem/'); ?>?s=<?php echo $TenSP; ?>&trang=<?php echo $_GET['trang'] - 1; ?>">«</a>
                        <?php } else { ?>
                                <a href="#">«</a>
                        <?php } ?>
                        ...
                        <?php for ($i = 1; $i <= $page; $i++) { ?>
                            ...
                            <?php } else if (isset($_GET['trang']) && $i == $_GET['trang']) { ?>
                                    <a class="active"
                                        href="<?php echo base_url('tim-kiem/?'); ?>s=<?php echo $TenSP; ?>&trang=<?php echo $i; ?>"><?php echo $i; ?></a>
                            <?php } else { ?>
